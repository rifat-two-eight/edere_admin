        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16 items-start">
          ...
          <div>
            ...
            <ul className="space-y-4 text-[#2D2A26]/80">
              <li>
                <Link href="/mission" className="hover:text-[#055E2C]">
                  Our Mission
                </Link>
              </li>
              <li>
                <Link href="/faq" className="hover:text-[#055E2C]">
                  FAQs
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:text-[#055E2C]">
                  Terms + Conditions
                </Link>
              </li>
              <li>
                <Link href="/policy" className="hover:text-[#055E2C]">
                  Privacy Policy
                </Link>
              </li>
            </ul>
