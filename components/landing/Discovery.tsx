      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col xl:flex-row items-center">
          ...
          <div className="w-full xl:w-1/2 text-center xl:text-left">
            <h2 className="text-3xl sm:text-4xl md:text-6xl lg:text-7xl xl:text-[64px] font-extrabold mb-6 text-gray-900" style={{ fontFamily: 'athletics' }}>
              Restaurant
              <br className="block" />
              discovery{" "}
              <span className="text-[#055E2C]">simplified</span>
            </h2>
            <p className="text-xl sm:text-2xl md:text-[32px] lg:text-[36px] xl:text-[32px] text-[#2D2A26] mb-8 font-semibold" style={{ fontFamily: 'athletics' }}>
              Discover restaurants that work for you
            </p>

            <ul className="space-y-6 mb-10 text-left max-w-lg mx-auto xl:mx-0">
          ...
          <div className="w-full xl:w-1/2 flex items-center justify-center mt-16 xl:mt-0">

            {/* ── MOBILE/TABLET layout (< xl) ── */}
            <div className="xl:hidden relative w-full max-w-[320px] md:max-w-[520px] lg:max-w-[600px] mx-auto">
              ...
              <div className="absolute -top-6 -left-4 md:-top-6 md:-left-12 w-32 sm:w-40 md:w-52 lg:w-56 shadow-2xl rounded-xl overflow-hidden bg-white border border-gray-100 z-10">
                <Image src="/location.png" alt="Nearby restaurants" width={222} height={193} className="w-full h-auto" />
              </div>
              <div className="absolute top-1/2 -right-4 md:-right-8 transform -translate-y-1/2 w-32 sm:w-40 md:w-52 lg:w-56 shadow-2xl rounded-xl overflow-hidden bg-white border border-gray-100 z-10">
            ...
            {/* ── DESKTOP layout (xl+) ── */}
            <div className="hidden xl:block relative w-[627px] h-[639px]">
              <Image
                src="/discovery.png"
                alt="Food discovery"
                width={627}
